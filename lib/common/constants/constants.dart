...
const Color kThridColor = Color(0xffADC2A9);
const Color kPointColor = Color(0xff00EFDA);
const Color kSpacerColor = Color(0xffF2F2F2);
const Color kFormLabelColor = Color(0xffA8A8A8);
const Color kHintTextColor = Color(0xffB7B7B7);
const Color kTextBlackColor = Color(0xFF313131);
const Color kTextWhiteColor = Color(0xFFFFFFFF);
const Color kTextLightColor = Color(0xFFA5A5A5);
const Color kTextGreyColor = Color(0xFF606060);
const Color kBackgroundColor = Color(0xffFEF5ED);
